...
<?php $__env->startSection('title', 'Banking & Fintech Solutions | Accrosian'); ?>
...
<div class="bk">
    ...
    <section class="bk-hero">
        <img src="<?php echo e(asset('assets/images/hero-banking.png')); ?>" alt="Hero Background" class="hero-bg-img" />
        <div class="bk-wrap">
            <div class="bk-hero-grid">
                ...
                <div>
                    ...
                    <div class="bk-hero-btns">
                        <a href="<?php echo e(route('contact')); ?>" class="bk-btn bk-btn-orange">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="bk-btn bk-btn-outline-white">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2.5" style="width:15px;height:15px">
        ...
        <div class="bk-wrap">
            ...
            <div class="bk-cards">
                <div class="bk-card">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="bk-card-link">Learn more <svg
        ...
        <div class="bk-wrap">
            <div class="bk-why-grid">
                ...
                <div class="bk-right-full-image">
                    <img src="<?php echo e(asset('assets/images/banks.jpg')); ?>" alt="Banking Solutions">
                </div>
                <!-- <div>
            ...
            <div class="bk-contact-grid">
                ...
                <div>
                    <div class="bk-form-card">
                        <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="bk-form">
                            <?php echo csrf_field(); ?>
                            <div class="bk-row2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/frontend/banking.blade.php ENDPATH**/ ?>