...
<?php $__env->startSection('title', 'Energy & Sustainability Solutions | Accrosian'); ?>
...
<body>
    ...
    <section class="hero" id="hero">
        <img src="<?php echo e(asset('assets/images/hero-energy.png')); ?>" alt="Hero Background" class="hero-bg-img" />
            ...
            <div class="challenges-inner">
                <div class="challenges-left reveal">
                    ...
                    <div class="challenge-image-wrap">
                        <img src="<?php echo e(asset('assets/images/energy-img.jpg')); ?>" alt="Energy Infrastructure">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppNew\htdocs\accroNew\resources\views/frontend/energy.blade.php ENDPATH**/ ?>