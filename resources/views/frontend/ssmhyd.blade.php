            ...
            <div class="bk-hero-grid">
                ...
                <div>
                    <h1 class="bk-h1 bk-hero-title">
                        Social Media Marketing<span class="grad-orange"> Hyderabad</span>
                    </h1>
        ...
        <div class="bk-wrap">
            ...
            <div class="bk-sec-head">
                ...
                <h2 class="bk-h2" style="margin-top:16px;">
                    ...
                    <span class="grad-orange">Service in Hyderabad</span>
                </h2>
                ...
                <p class="bk-sub">
                    ...
                    Services in Hyderabad. We manage your social media so
            ...
            <div class="sm-services">
                ...
                <div class="sm-item">
                    ...
                    <div>
                        ...
                        <p>Customized social media strategies designed for businesses in Hyderabad.</p>
                    </div>
                    <span class="arrow">
                        <i class="fas fa-arrow-right"></i>
                    </span>
        ...
        <div class="smm-why-wrap">
            ...
            <div class="smm-why-header">
                ...
                <p class="smm-why-intro">
                    ...
                    for your business in Hyderabad.
                </p>
                ...
                <div class="smm-growth-content">
                    ...
                    <div class="smm-point">
                        ...
                        <p>
                            ...
                            We create social media strategies around Hyderabad's
