...
/* ═══════════════════════════════════════════════
   INTEGRATION HUB — floating logos, scroll fly-in
═══════════════════════════════════════════════ */
.bk-integ-scroll {
    position: relative;
    height: 620px;
...
.bk-integ-hub {
    ...
    box-shadow: 0 0 0 1px rgba(46, 106, 255, .08), 0 30px 70px rgba(0, 0, 0, .5), 0 0 70px rgba(249, 115, 22, .14);
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
.bk-integ-scroll.is-visible .bk-integ-hub {
    opacity: 1;
...
.bk-integ-hub-ico {
    ...
    align-items: center;
    justify-content: center;
    box-shadow: 0 8px 24px rgba(232, 117, 10, .4);
}

.bk-integ-hub-ico svg {
    width: 26px;
    height: 26px;
    color: #fff;
}
...
/* connecting rings, purely decorative */
.bk-integ-ring {
    position: absolute;
    top: 50%;
    left: 50%;
    border-radius: 50%;
    border: 1px dashed rgba(46, 106, 255, .16);
...
.bk-integ-scroll.is-visible .bk-integ-ring {
    opacity: 1;
}
...
.bk-integ-pill {
    ...
    opacity: 0;
    z-index: 2;
    transition: opacity .8s cubic-bezier(.16, 1, .3, 1), transform .8s cubic-bezier(.16, 1, .3, 1), border-color .28s, box-shadow .28s;
...
.bk-integ-pill[data-pos="top"] {
    top: 0;
    left: 50%;
    transform: translate(-50%, 0);
}

.bk-integ-pill[data-pos="tl"] {
    top: 90px;
    left: 30px;
}

.bk-integ-pill[data-pos="tr"] {
    top: 90px;
    right: 30px;
}

.bk-integ-pill[data-pos="ml"] {
    top: 280px;
    left: -20px;
}

.bk-integ-pill[data-pos="mr"] {
    top: 280px;
    right: -20px;
}

.bk-integ-pill[data-pos="bl"] {
    top: 470px;
    left: 60px;
}

.bk-integ-pill[data-pos="br"] {
    top: 470px;
    right: 60px;
}

/* fly-in start offsets, by direction the pill approaches from */
.bk-integ-pill[data-dir="top"] {
    transform: translate(-50%, -220px) scale(.6);
}

.bk-integ-pill[data-dir="left"] {
    transform: translate(-260px, 0) scale(.6);
}

.bk-integ-pill[data-dir="right"] {
    transform: translate(260px, 0) scale(.6);
}

.bk-integ-pill[data-dir="bottom"] {
    transform: translate(0, 220px) scale(.6);
}

.bk-integ-scroll.is-visible .bk-integ-pill {
    opacity: 1;
}

.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="top"] {
    transform: translate(-50%, 0) scale(1);
}

.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="tl"],
.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="ml"],
.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="bl"] {
    transform: translate(0, 0) scale(1);
}

.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="tr"],
.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="mr"],
.bk-integ-scroll.is-visible .bk-integ-pill[data-pos="br"] {
    transform: translate(0, 0) scale(1);
}
...
.cta-actions .btn-primary2 {
    background: var(--gradient-orange);
    color: var(--white);
    box-shadow: 0 4px 24px rgba(232, 117, 10, 0.35);
}

.cta-actions .btn-outline2 {
    background: var(--gradient-orange);
    color: var(--white);
    border: 1px solid rgba(255, 255, 255, 0.25);
}

.cta-actions .btn-outline2:hover {
    transform: translateY(-4px);
    box-shadow: 0 8px 32px rgba(232, 117, 10, 0.5);
}
            ...
            <div class="bk-hero-grid">
                ...
                <div class="hero-content">
                    <h1 class="bk-h1 bk-hero-title">
                        WhatsApp Automation with<br>
                        <span class="grad-orange">Smart Workflow Integration</span>
                    </h1>
                    <p class="bk-hero-sub">Revolutionize Customer Engagement and Business Efficiency.Introducing our
                        WhatsApp Automation solution, enhanced with Smart Workflow
                        Integration to bring unparalleled efficiency and personalization to your communication
                        strategies. Whether you’re managing customer inquiries, marketing campaigns, or internal
                        processes, our advanced platform empowers you to connect, automate, and succeed like never
                        before.</p>
    ...
    <section class="bk-sec">
        <div class="bk-wrap">
            <div class="bk-sec-head">
                ...
                <h2 class="bk-h2" style="margin-top:16px;">Scale Customer Conversations with <span
                        class="grad-orange">Intelligent WhatsApp Automation</span></h2>
                <div class="bk-divider"></div>
                <p class="bk-sub">From AI-powered chatbots to bulk messaging and workflow automation everything you need
                    to convert more leads and delight customers.</p>
            </div>
    ...
    <section class="bk-sec bk-sec-alt">
        <div class="bk-wrap">
            <div class="bk-why-grid">
                {{-- Left --}}
                <div>
                    <h2 class="bk-h2">Benefits of WhatsApp &amp; Automation <span class="grad-orange">with Smart &amp;
                            Workflow</span></h2>
                    <div class="bk-divider" style="margin:14px 0 20px;"></div>
                    <p class="bk-sub" style="margin-top:0;margin-bottom:32px;">Automate customer conversations, lead
                        nurturing, and follow-ups with intelligent workflows that save time and eliminate repetitive
                        tasks. Deliver instant, personalized responses while improving customer engagement, boosting
                        conversions, and increasing team productivity.</p>
                    ...
                    <div class="bk-feature-list">
                        <div class="bk-feat-item">
                            ...
                            <div class="bk-feat-body"><strong>Enhanced Efficiency</strong><span>Automate repetitive
                                    tasks to save time and resources.</span></div>
                        </div>
                        <div class="bk-feat-item">
                            <div class="bk-feat-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
                            ...
                            <div class="bk-feat-body"><strong>Improved Engagement</strong><span>Deliver timely,
                                    personalized messages that resonate with your audience.</span></div>
                        </div>
                        <div class="bk-feat-item">
                            <div class="bk-feat-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
                            ...
                            <div class="bk-feat-body"><strong>Seamless Integration</strong><span>Combine WhatsApp
                                    automation with your existing systems for unified operations.</span></div>
                        </div>
                        <div class="bk-feat-item">
                            <div class="bk-feat-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
                            ...
                            <div class="bk-feat-body"><strong>Scalable Solutions</strong><span>Adapt to the growing
                                    demands of your business effortlessly.</span></div>
                        </div>
                        <div class="bk-feat-item">
                            <div class="bk-feat-ico"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5">
        ...
        <div class="bk-wrap">
            ...
            <div class="bk-integ-scroll" id="integScroll">
                ...
                <div class="bk-integ-hub">
                    ...
                    <span>Accrosian<br>WhatsApp<br>Automation</span>
                </div>
    ...
    <section class="bk-sec">
        <div class="bk-wrap">
            <div class="bk-sec-head">
                ...
                <h2 class="bk-h2" style="margin-top:16px;">Features and Benefits <span class="grad-orange">You Can't
                        Miss</span>
                </h2>
                <div class="bk-divider"></div>
            ...
            <div class="bk-feat-grid">
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>Effortless Scheduling</strong>
                        <p>Schedule and publish content across all social accounts on your preferred date and time
                            effortlessly.</p>
                    </div>
                </div>
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>Performance Analytics</strong>
                        <p>Track performance, analyze audience behavior, and optimize content strategies to maximize
                            engagement across all platforms.</p>
                    </div>
                </div>
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>Bulk Post Scheduling</strong>
                        <p>Schedule multiple posts simultaneously and automate publishing across all social platforms
                ...
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>Connect Social Account</strong>
                        <p>Easily connect Facebook and Instagram accounts with one login to enable automation and page
                            management.</p>
                    </div>
                </div>
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>Create Comment Reply</strong>
                        <p>Automatically reply to comments, hide offensive messages, and reuse saved response templates
                            for faster engagement.</p>
                    </div>
                </div>
                <div class="bk-feat-cell">
                    ...
                    <div class="bk-feat-cell-txt"><strong>24/7 Messenger Bot</strong>
                        <p>Build intelligent Messenger chatbots that automate conversations and provide instant customer
                            support 24/7 effortlessly.</p>
                    </div>
                </div>
            </div>
        </div>
