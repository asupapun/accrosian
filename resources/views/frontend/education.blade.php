    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-inner">
                ...
                <div class="hero-visual fu fu4">
                    <div class="dash">
                        <div class="dash-top">
                            <span class="dash-title">LEARNING ANALYTICS DASHBOARD</span>
                            <span class="live-dot">Live</span>
                        </div>
                        <div class="dash-kpis">
                            <div class="kpi">
                                <div class="kpi-val">18<span>K</span></div>
                                <div class="kpi-label">Active Learners</div>
                            </div>
                            <div class="kpi">
                                <div class="kpi-val">94<span>%</span></div>
                                <div class="kpi-label">Completion Rate</div>
                            </div>
                            <div class="kpi">
                                <div class="kpi-val">4.8<span>★</span></div>
                                <div class="kpi-label">Avg Rating</div>
                            </div>
                        </div>
                        <div class="dash-chart">
                            <div class="chart-label"><span>Course Engagement</span><span
                                    style="color:var(--orange-400)">+28% this week</span></div>
                        ...
                        <div class="dash-students">
                            <div class="stu-row">
                                <div class="stu-avatar" style="background:linear-gradient(135deg,#f97316,#fdba74)">AJ
                                </div>
                                <div class="stu-info">
                                    <div class="stu-name">Aanya Joshi</div>
                                    <div class="stu-prog-track">
                                        <div class="stu-prog-fill" style="width:82%"></div>
                                    </div>
                                </div>
                                <div class="stu-pct">82%</div>
                            </div>
                            <div class="stu-row">
                                <div class="stu-avatar" style="background:linear-gradient(135deg,#6366f1,#a5b4fc)">RK
                                </div>
                                <div class="stu-info">
                                    <div class="stu-name">Rohan Kumar</div>
                                    <div class="stu-prog-track">
                                        <div class="stu-prog-fill" style="width:67%"></div>
                                    </div>
                                </div>
                                <div class="stu-pct">67%</div>
                            </div>
                            <div class="stu-row">
                                <div class="stu-avatar" style="background:linear-gradient(135deg,#10b981,#6ee7b7)">SM
                                </div>
                                <div class="stu-info">
                                    <div class="stu-name">Sara Mehta</div>
                                    <div class="stu-prog-track">
                                        <div class="stu-prog-fill" style="width:91%"></div>
                                    </div>
                                </div>
                                <div class="stu-pct">91%</div>
                            </div>
                            <div class="stu-row">
                                <div class="stu-avatar" style="background:linear-gradient(135deg,#f43f5e,#fda4af)">KP
                                </div>
                                <div class="stu-info">
                                    <div class="stu-name">Kunal Patil</div>
                                    <div class="stu-prog-track">
                                        <div class="stu-prog-fill" style="width:55%"></div>
                                    </div>
                                </div>
                                <div class="stu-pct">55%</div>
                            </div>
                        </div>
                    </div>
                    <div class="float-chip">
                        ...
                        <div>
                            <div class="chip-val">+41%</div>
                            <div class="chip-text">Engagement uplift</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat">
                    ...
                    <div class="stat-l">Platform Uptime Guaranteed</div>
                </div>
                <div class="stat">
                    <div class="stat-n">500K+</div>
                    <div class="stat-l">Learners Served Globally</div>
                </div>
                <div class="stat">
                    <div class="stat-n">3×</div>
                    <div class="stat-l">Faster Learning Delivery</div>
                </div>
                <div class="stat">
                    <div class="stat-n">80+</div>
                    <div class="stat-l">EdTech Platforms Built</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="why-grid">
                <div>
                    ...
                    <h2
                        style="font-family:'Syne',sans-serif;font-size:clamp(1.8rem,3vw,2.4rem);font-weight:800;letter-spacing:-.02em;margin-bottom:14px;line-height:1.2">
                        Built for Platforms That <em
                            style="font-style:normal;background:linear-gradient(135deg,var(--orange-400),var(--orange-300));-webkit-background-clip:text;-webkit-text-fill-color:transparent">Cannot
                            Fail</em></h2>
